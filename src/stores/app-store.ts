...
export type ModalType = 'ADD_PLACE' | 'ADD_ROUTE' | 'RESTAURANT_DETAIL' | 'INFO_MESSAGE';
...
export interface ModalState<T extends ModalType | null = null> {
  type: T;
  props?: T extends 'ADD_PLACE' ? AddPlaceModalProps :
         T extends 'ADD_ROUTE' ? AddRouteModalProps :
         T extends 'RESTAURANT_DETAIL' ? RestaurantDetailModalProps :
         T extends 'INFO_MESSAGE' ? InfoMessageModalProps :
