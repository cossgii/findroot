        ...
        <div className="text-center md:text-left">
          <FadeInContent sectionIndex={1} currentPage={currentPage}>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              맛집, 카페, 산책로. 나만 알고 싶은 장소들을 지도에 저장하고, 다른
              사람들의 추천도 확인해보세요.
            </p>
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex items-center space-x-4 text-gray-600 pt-1">
              ...
              <p className="text-gray-700 my-4">{selectedPlace.description}</p>
            </div>
          </FadeInContent>
        </div>
...
export const RoutesSection = ({ currentPage }: { currentPage: number }) => {
  return (
    ...
    >
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center px-4">
        <div className="relative h-96 w-full rounded-lg shadow-xl overflow-hidden order-last md:order-first">
          <Image
            src={LandingPicture}
            alt="홍대 지도"
            fill
        ...
        <div className="text-center md:text-left order-first md:order-last">
          <FadeInContent sectionIndex={2} currentPage={currentPage}>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              저장한 장소들을 엮어 성수동 카페 투어, 가족 나들이 코스 등 나만의
              루트를 만들어보세요. 다른 사람들을 팔로우를 하여 추천된 장소와
              루트도 즐겨보세요.
            </p>
            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
              <div className="mb-3">
