...
export const SEOUL_DISTRICTS: DistrictInfo[] = [
  { id: 'all', name: '전체', lat: 37.5665, lng: 126.9780 }, // 서울시청 기준
  ...
  { id: 'Geumcheon-gu', name: '금천구', lat: 37.4519, lng: 126.9020 },
  ...
  { id: 'Yongsan-gu', name: '용산구', lat: 37.5325, lng: 126.9900 },
  { id: 'Eunpyeong-gu', name: '은평구', lat: 37.6027, lng: 126.9291 },
  { id: 'Jongno-gu', name: '종로구', lat: 37.5730, lng: 126.9794 },
